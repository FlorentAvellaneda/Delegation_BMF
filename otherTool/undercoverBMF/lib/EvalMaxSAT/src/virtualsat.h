...
public:
    ...
    virtual int newVar(bool decisionVar=true) {assert(!"TODO");}
    ...
    CardIncremental_Lazy newCard2(const std::vector<int> &clause, unsigned int bound=1) {
        return CardIncremental_Lazy(this, clause, bound);
    }
